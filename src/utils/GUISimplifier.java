...
public class GUISimplifier {

    private GUISimplifier() {
    }

    public static Button newButton(String text,
                                   Color backgroundColor,
                                   EventHandler<ActionEvent> onClick,
                                   Consumer<MouseEvent> hoverStart,
                                   Consumer<MouseEvent> hoverEnd) {
